...
for k = sta:fin
    ind = k;
    image_disp = uint8(imread(['../../OneDrive - m.titech.ac.jp/Lab/data/sample_image_col', int2str(n), '/test_', int2str(ind), '.png']));
    ...
    imwrite(img, ['../../OneDrive - m.titech.ac.jp/Lab/data/capture_', expDate, '/test_' int2str(ind), '.png'], 'BitDepth', 8);
